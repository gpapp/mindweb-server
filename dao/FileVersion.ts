...
export default class FileVersion extends DAOBase {
    public createNewVersion(id:string|cassandra.types.Uuid, version:number, content:string, next:(error:ServiceError,result:cassandra.ExecuteResult)=>void) {
    ...
    public updateVersion(id:string|cassandra.types.Uuid, content:string, next:(error:ServiceError,result:cassandra.ExecuteResult)=>void) {
    ...
    public getContent(fileVersionId:string|cassandra.types.Uuid, next:(error:ServiceError,result:cassandra.ExecuteResult)=>void) {
