...
export default class User extends DAOBase {
    ...
    public createUser(userId:string|cassandra.types.Uuid, persona:string[], name:string, email:string, avatarUrl:string, next:Function) {
    ...
    public deleteUser(userId:string|cassandra.types.Uuid, next:Function) {
