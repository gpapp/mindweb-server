...
export default class UserPersona extends DAOBase {
    ...
    public getPersona(authId:string, next:(error:ServiceError,result:cassandra.ExecuteResult)=>void) {
    ...
    public createPersona(authId:string, name:string, email:string, avatarUrl:string, next:(error:ServiceError,result:cassandra.ExecuteResult)=>void) {
    ...
    public deletePersona(authId:string, next:(error:ServiceError,result:cassandra.ExecuteResult)=>void) {
